...
# for NUM in {1..100}; do
# sbatch -p medium -t 24:0:0 -n 4 -o logfile_${NUM}.log -N 1 --mem=15G --wrap="source ~/.bashrc; conda activate mobpsopti;  Rscript --vanilla Simulation_Script.R ${NUM}"; 
# done
...
for(setting in 1:500){
  ...
  # n_test <- number of cows used for testing
  # n_bull <-number of new bulls generated (This should be variable!)
  # n_bull_sel <- number of sires used for the next generation (This should be variable!)

## In each iteration n_bull and n_bull_sel will reduce to the the reduced space parameters  
